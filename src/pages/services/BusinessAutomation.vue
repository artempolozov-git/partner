<template>
  <div class="page-main__container">
    ...
    <div class="text__container">
      ...
      <p class="text"><b>Автоматизация бизнес процессов</b> — простыми словами, это перенос выполнения рутинных и однотипных задач в профессиональные программы, которые упрощают и ускоряют реализацию
